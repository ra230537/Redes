...
{
    // Verificar se a porta e backlog foram fornecidos
    if (argc != 3)
    {
    ...
    int backlog = atoi(argv[2]);               // Valor de backlog
    ...
    while (1)
    {
        sleep(1); // Adicionar um sleep para observar o comportamento com diferentes backlogs
        ...
        *client_socket_ptr = accept(server_socket, (struct sockaddr *)&client_addr, &client_len);
        ...
        // Imprimir o IP e a porta do cliente conectado
